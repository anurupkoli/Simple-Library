...
class library :
        ...
        def issuebook(self, bookname):
            if bookname in self.books :
                print(f"{bookname} book has been issued. Please return it within 20 days.")
                self.books.remove(bookname)
            else :
                print(f"Sorry but {bookname} book is either issued to someone or it is not available. Please eait until it is available")
